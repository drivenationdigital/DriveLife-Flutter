  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          _buildSection('Current Vehicles', _currentVehicles),
          const SizedBox(height: 24),
          _buildSection('Past Vehicles', _pastVehicles),
          const SizedBox(height: 24),
          _buildSection('Dream Vehicles', _dreamVehicles),
        ],
      ),
    );
  }

  Widget _buildSection(String title, List<dynamic> vehicles) {
    return Column(
